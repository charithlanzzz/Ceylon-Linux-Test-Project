                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select  style="color:black; background-color: #def7e2;"
                                        ...
                                        @foreach($products as $product)
                                            <option value="{{$product->id}}" {{($product->id == $freeissue->purchase_product) ? 'selected' : ''}}>{{$product->product_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" style="color:black; background-color: #def7e2"
                                        class="form-control" name="free_product" id="free_product" value="{{ $freeissue->free_product }}"
                                        required /><br>
                                </div>
                            </div>
                            <div class="row">
