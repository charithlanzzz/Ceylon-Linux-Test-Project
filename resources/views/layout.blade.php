    ...
    <nav class="topnav-right" style="background-color: #6EBD6C; height:60px">
        ...
        <li class="nav-item" type="none" style="float:left; margin-left: 20px">
            <a href="/" style="text-decoration: none">
                <h2 style="color: white;margin-top:10px">Test Project</h2>
            </a>
        </li>
        ...
        <ul class="nav justify-content-end" style="">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/customers" style="color: white;margin-top:10px">Customers</a>
            </li>
            <li class="nav-item">
